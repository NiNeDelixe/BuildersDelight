...
public class CTBlockModelLoader implements IGeometryLoader<CTBlockModelLoader.CTModelGeometry> {
    ...
    public static class CTModelGeometry implements IUnbakedGeometry<CTModelGeometry> {
        ...
        public BakedModel bake(IGeometryBakingContext context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides) {
            return new CTConnectedBakedModel(context, GENERATOR_LOADER); //TODO: This is a hack, but it works for now. The model location is not used in the baked model, so we can just pass in a dummy value.
        }
    }
}
