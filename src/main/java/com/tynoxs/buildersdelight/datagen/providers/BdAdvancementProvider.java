...
public class BdAdvancementProvider implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
        AdvancementHolder rootAdvancement = Advancement.Builder.advancement()
                ...
                .save(saver, ResourceLocation.fromNamespaceAndPath(BuildersDelight.MODID, "root"));
        ...
        AdvancementHolder ironChisel = Advancement.Builder.advancement()
                ...
                .save(saver, ResourceLocation.fromNamespaceAndPath(BuildersDelight.MODID, "iron_chisel"));
        ...
        AdvancementHolder furnitureKit = Advancement.Builder.advancement()
                ...
                .save(saver, ResourceLocation.fromNamespaceAndPath(BuildersDelight.MODID, "furniture_kit"));
    }
}
